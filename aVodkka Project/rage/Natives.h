...
#include "rage/nativeCaller.h"




//Random Natives No namespace needed
opd_s PRINT_TEXT_TYPE_t = { 0x3C8210, TOC };
int(*__PRINT_TEXT_TYPE)(const char* p1) = (int(*)(const char*)) & PRINT_TEXT_TYPE_t;
opd_s _add_text_component_string = { 0x3C85D0, TOC };
void(*__PRINT_TEXT_TEXT)(const char* text) = (void(*)(const char*)) & _add_text_component_string;
opd_s PRINT_TEXT_TIME_t = { 0x3C8230, TOC };
...
static BOOL GET_WATER_HEIGHT1(float x, float y, float z, float* height) { return invoke<BOOL>(0xD864E17C, x, y, z, height); } // 0xD864E17C
...
static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS1(Entity Entity, float xCoord, float yCoord, float zCoord) { return invoke<Vector3>(0xABCF043A, Entity, xCoord, yCoord, zCoord); } // 0xABCF043A
int ReadInt32(int Address) { return *(int*)Address; }
...
opd_s DRAW_LIGHT_WITH_RANGE_t = { 0x3BE150, TOC };
void(*DRAW_LIGHT_WITH_RANGE)(Vector3* Loc, int R, int G, int B, float Intensity, float Range) = (void(*)(Vector3 * Loc, int, int, int, float, float)) & DRAW_LIGHT_WITH_RANGE_t;
static char* GET_THIS_SCRIPT_NAME() { return invoke<char*>(0xA40FD5D9); } // 0xA40FD5D9
char* _GET_LABEL_TEXT(Any p0) { invoke<Void>(0x95C4B5AD, p0); }// 7B5280EBA9840C72 95C4B5AD
...
static void NETWORK_HANDLE_FROM_PLAYER2(Ped PedHandle, int* FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
static char* NETWORK_GET_GAMERTAG_FROM_HANDLE(int* p0) { return invoke<char*>(0xA18A1B26, p0); } // 0xA18A1B26
static void ATTACH_ENTITY_TO_ENTITY_PHYSICALLY(Entity entity1, Entity entity2, float bone1, float bone2, float x1, float y1, float z1, float x2, float y2, float z2, float rot_x, float rot_y, float rot_z, Any breakforce, Any fixedrot, Any p15, Any collision, Any p17, Any p18) { invoke<Void>(0x0547417F, entity1, entity2, bone1, bone2, x1, y1, z1, x2, y2, z2, rot_x, rot_y, rot_z, breakforce, fixedrot, p15, collision, p17, p18); } // 0x0547417F
static Vector3 GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS2(Entity Entity, int xCoord, int yCoord, int zCoord) { return invoke<Vector3>(0xABCF043A, Entity, xCoord, yCoord, zCoord); } // 0xABCF043Astatic BOOL DOES_ENTITY_EXIST(Entity entity) { return invoke<BOOL>(0x3AC90869, entity); } // 0x3AC90869
...
static int NETWORK_CREATE_SYNCHRONISED_SCENE1(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<Any>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } //  0xB06FE3FE
static void ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(char* text) { invoke<Void>(0x27A244D8, text); } // 0x27A244D8
//Random Player ID Defs

opd_s snprintf_stub = { 0x14FDCEC, TOC }; //1.27
...
unsigned char CREATE_AMBIENT_PICKUP_FIX_BYTES[] = { 0x48, 0x00, 0x01, 0x38 };
unsigned char NOP[] = { 0x60, 0x00, 0x00, 0x00 };
unsigned char bytes[] = { 0x4B, 0xB3, 0x3C, 0x79 };
unsigned char bytes2[] = { 0x4B, 0xA7, 0xDF, 0x3D };
unsigned int
CREATE_AMBIENT_PICKUP_FIX = 0x3FA510,
NETWORK_PLAYER_IS_BADSPORT = 0x3F1D04,

WEAPON_EDITOR_POINTER = 0x21474F0,
HANDLING_POINTER = 0x208D1B8,

GET_ENTITY_MODEL = 0x1C24D90,
GET_ENTITY_MODEL_RPC = 0x3AC274,
GET_ENTITY_MODEL_DISABLE = 0x1571DC0,

IS_PLAYER_ONLINE = 0x1C2BB80,
IS_PLAYER_ONLINE_RETURN = 0x2242320,
IS_PLAYER_ONLINE_RPC = 0x3E3A20,

Superman = 0x1E459E4,
GaragePointer = 0x1E70390,
SuperPunch = 0x1CFB0A0,
OffTheRadarPointer = 0x1E70394,
OffTheRadarGap = 0x22284,
BullsharkGap = 0x24C18,

GET_INDEX_OF_CURRENT_LEVEL = 0x1C271E0,
GET_INDEX_OF_CURRENT_LEVEL_RPC = 0x3D7B04,
_PLAYER_ID = 0x1C2BB30,
_PLAYER_ID_RPC = 0x424290,
//SET_ENTITY_CAN_BE_DAMAGED = 0x1C25008,
SET_ENTITY_CAN_BE_DAMAGED_RPC = 0x3B2888,
...
GET_HASH_KEY = 0x1C26E48,
GET_HASH_KEY_RPC = 0x110C78,

GLOBALPTR = 0x1E70370,
ADD_GET_PED_LAST_WEAPON_IMPACT_COORD = 0x468F40,
IS_DLC_PRESENT = 0x1C27768,
RockstarDev = 0x3E30D8,
PlayerNameLocal = 0x41143344,
PlayerNameActual = 0x0200255C,
GET_MODEL_DIMENSIONS_FUNC = 0x9D9830,
PlayerClanName = 0x222D93E,
PlayerClanTag = 0x222D957,
TunablePointer = 0x1E70374;
...
namespace Func
{
	...
	opd_s STAT_SET_INT_t = { 0x42BE0C, TOC };//1.26
	void(*STAT_SET_INT)(int Hash, int Value, int Number) = (void(*)(int, int, int)) & STAT_SET_INT_t;

	opd_s STAT_SET_BOOL_t = { 0x42C2A4, TOC };//1.26
	void(*STAT_SET_BOOL)(int Hash, int ukn, int ukn2) = (void(*)(int, int, int)) & STAT_SET_BOOL_t;

	opd_s DISPLAY_ONSCREEN_KEYBOARD_t = { 0x3D962C, TOC };//1.26
	int(*DISPLAY_ONSCREEN_KEYBOARD)(int x, const char* a, const char* b, const char* c, const char* d, const char* e, const char* f, int maxLength) = (int(*)(int, const char*, const char*, const char*, const char*, const char*, const char*, int)) & DISPLAY_ONSCREEN_KEYBOARD_t;

	opd_s network_earn_from_rockstar_t = { 0x3DD408, TOC };//1.26
	void(*network_earn_from_rockstar)(int amount) = (void(*)(int)) & network_earn_from_rockstar_t;

	opd_s GET_RANDOM_INT_IN_RANGE_t = { 0x3D463C, TOC };
	int(*GET_RANDOM_INT_IN_RANGE)(int lowest, int highest) = (int(*)(int, int)) & GET_RANDOM_INT_IN_RANGE_t;

	opd_s DRAW_LIGHT_WITH_RANGE_t = { 0x3BE150, TOC };
	void(*DRAW_LIGHT_WITH_RANGE)(Vector3* Loc, int R, int G, int B, float Intensity, float Range) = (void(*)(Vector3 * Loc, int, int, int, float, float)) & DRAW_LIGHT_WITH_RANGE_t;

	int TunablesPtr = 0x1E70374;
...
namespace ENTITY
{
	...
	//static vec3_t GET_ENTITY_COORDS2(Entity entity, BOOL unkBool) { return invoke<vec3_t>(0x1647F1CB, entity, unkBool); } // 0x1647F1CB
...
namespace PED
{
	//static BOOL GET_CLOSEST_PED(float x, float y, float z, float radius, bool p4, bool p5, Ped* outPed, bool p7, bool p8, int pedType);
	static void _SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(Ped ped, int state) { invoke<Void>(0x8A251612, ped, state); } // 0x8A251612 
	...
	static void _SET_PED_MOVEMENT_CLIPSET(Any p0, const char* p1, Any p2) { invoke<Void>(0xA817CDEB, p0, p1, p2); } // 0xA817CDEB
	...
	static Ped __GET_CLOSEST_PED(float x, float y, float z, float Radius, BOOL p4, BOOL p5, int* handle, BOOL p7, BOOL p8, int p9) { return invoke<Ped>(0x8F6C1F55, x, y, z, Radius, p4, p5, handle, p7, p8, p9); } // 0x8F6C1F55
	...
	static Vector3 _GET_PED_BONE_COORDS(Ped ped, int boneId, float offsetX, float offsetY, float offsetZ) { return invoke<Vector3>(0x4579CAB1, ped, boneId, offsetX, offsetY, offsetZ); } // 0x4579CAB1
...
namespace VEHICLE
{
	static void _GET_VEHICLE_EXTRA_COLOURS(Vehicle vehicle, int* pearl, int* wheel) { invoke<Void>(0x80E4659B, vehicle, pearl, wheel); } // 0x80E4659B
	static char* GET_DISPLAY_NAME_FROM_VEHICLE_MODEL1(Hash modelHash) { return invoke<char*>(0xEC86DF39, modelHash); }// 0xEC86DF39
	static void _SET_VEHICLE_ENGINE_POWER_MULTIPLIER(Vehicle vehicle, float value) { invoke<Void>(0xE943B09C, vehicle, value); } // 0x93A3996368C94158 0xE943B09C
	...
	static uint CREATE_VEHICLE0(Hash VehicleHash, Vector3 xyz, float Heading, BOOL networkHandle, BOOL vehiclehandle) { return invoke<uint>(0xDD75460A, VehicleHash, xyz, Heading, networkHandle, vehiclehandle); } // 0xDD75460A
...
namespace GAMEPLAY
{
	static void CLEAR_AREA_OF_PROJECTILES1(float p0, float p1, float p2, float p3, Any p4) { invoke<Void>(0x18DB5434, p0, p1, p2, p3, p4); } // 0x18DB5434
	static void CLEAR_AREA_OF_PEDS1(float XCoord, float YCoord, float zCoord, float Area, Any p4) { invoke<Void>(0x25BE7FA8, XCoord, YCoord, zCoord, Area, p4); } // 0x25BE7FA8
	static void CLEAR_AREA_OF_VEHICLES1(float p0, float p1, float p2, float p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0x63320F3C, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x63320F3C
	static void CLEAR_AREA_OF_OBJECTS1(float p0, float p1, float p2, float p3, Any p4) { invoke<Void>(0xBB720FE7, p0, p1, p2, p3, p4); } // 0xBB720FE7
	static void CLEAR_AREA_OF_COPS1(float p0, float p1, float p2, float p3, Any p4) { invoke<Void>(0x95C53824, p0, p1, p2, p3, p4); } // 0x95C53824
	static void CLEAR_AREA1(float p0, float p1, float p2, Any p3, Any p4, Any p5, Any p6, Any p7) { invoke<Void>(0x854E9AB8, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x854E9AB8
	static float _GET_DISTANCE_BETWEEN_COORDS(float x1, float y1, float z1, float x2, float y2, float z2, BOOL unknown) { return invoke<float>(0xF698765E, x1, y1, z1, x2, y2, z2, unknown); } // 0xF698765E
	...
	static void CLEAR_AREA_OF_PEDS(float x, float y, float z, float radius, BOOL unk) { invoke<Void>(0x25BE7FA8, x, y, z, radius, unk); } // 0x25BE7FA8 0x25BE7FA8
	...
	static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS(float StartPositionX, float StartPositionY, float StartPositionZ, float HitPositionX, float HitPositionY, float HitPositionZ, Any p6, Any p7, Hash WeaponHash, Ped PedHandle, Any p10, Any p11, float Speed) { invoke<Void>(0xCB7415AC, StartPositionX, StartPositionY, StartPositionZ, HitPositionX, HitPositionY, HitPositionZ, p6, p7, WeaponHash, PedHandle, p10, p11, Speed); } // 0xCB7415AC
	static void SHOOT_SINGLE_BULLET_BETWEEN_COORDS0(float StartPositionX, float StartPositionY, float StartPositionZ, float HitPositionX, float HitPositionY, float HitPositionZ, Any p6, Any p7, Hash ObjectHash, Ped PedHandle, Any p10, Any p11, float Speed) { invoke<Void>(0xCB7415AC, StartPositionX, StartPositionY, StartPositionZ, HitPositionX, HitPositionY, HitPositionZ, p6, p7, ObjectHash, PedHandle, p10, p11, Speed); } // 0xCB7415AC
...
namespace AUDIO
{
	...
	static void PLAY_SOUND_FROM_COORD222(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8){invoke<Void>(0xCAD3E2D5, p0, p1, p2, p3, p4, p5, p6, p7, p8);}
...
namespace STREAMING
{
	static void _REQUEST_ANIM_SET(char* p0) { invoke<Void>(0x2988B3FC, p0); } // 0x2988B3FC
	...
	static BOOL _HAS_ANIM_SET_LOADED(char* p0) { return invoke<BOOL>(0x4FFF397D, p0); } // 0x4FFF397D
...
namespace SCRIPT
{
	...
	static void TRIGGER_SCRIPT_EVENT(Any p0, int* p1, Any p2, Any p3) { invoke<Void>(0x54763B35, p0, p1, p2, p3); } // 0x54763B35
...
{
	char* _GET_LABEL_TEXT(Any p0) { invoke<Void>(0x95C4B5AD, p0); }// 7B5280EBA9840C72 95C4B5AD
	//char *_GET_LABEL_TEXT(char *labelName){ return invoke<char*>(0x95C4B5AD, *labelName); }// 7B5280EBA9840C72 95C4B5AD
	...
	static void _0x51E7A0372(char* p0) { invoke<Void>(0x51E7A037, p0); } // 0x51E7A037
...
namespace GRAPHICS
{
	...
	static void _SET_BLACKOUT(BOOL enable) { invoke<Void>(0xAA2A0EAF, enable); } // 0x1268615ACE24D504 0xAA2A0EAF
	static Any _START_PARTICLE_FX_LOOPED_ON_ENTITY_2(char* effectName, Entity entity, float xOffset, float yOffset, float zOffset, float xRot, float yRot, float zRot, float scale, BOOL xAxis, BOOL yAxis, BOOL zAxis) { return invoke<Any>(0x9604DAD4, effectName, entity, xOffset, yOffset, zOffset, xRot, yRot, zRot, scale, xAxis, yAxis, zAxis); } // 0x9604DAD4
	static Any _START_PARTICLE_FX_NON_LOOPED_ON_PED_BONE_2(char* effectName, Ped ped, float xOffset, float yOffset, float zOffset, float xRot, float yRot, float zRot, int boneIndex, float scale, BOOL p10, BOOL p11, BOOL p12) { return invoke<Any>(0x161780C1, effectName, ped, xOffset, yOffset, zOffset, xRot, yRot, zRot, boneIndex, scale, p10, p11, p12); } // 0x161780C1
	...
	//static void DRAW_RECT1(float posX, float posY, float scaleX, float scaleY, int R, int G, int B, int A) { invoke<Void>(0xDD2BFC77, posX + globalAddX, posY + globalAddY, scaleX, scaleY, R, G, B, A); } // 0xDD2BFC77
	...
	static void DRAW_SCALEFORM_MOVIE1(int p0, float p1, float p2, float p3, float p4, int p5, int p6, int p7, int p8) { invoke<Void>(0x48DA6A58, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0x48DA6A58
...
namespace STATS
{
	static Any STAT_SET_BOOL_NS(Hash statName, BOOL value) { return invoke<Any>(0x55D79DFB, statName, value); } // 0x55D79DFB
...
namespace TIME
{
	...
	static void GET_LOCAL_TIME2(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x124BCFA2, p0, p1, p2, p3, p4, p5); } // 0x124BCFA2
...
namespace FIRE
{
	static void ADD_OWNED_EXPLOSIO33N(Ped PedHandle, float x, float y, float z, int ExlosionType, float ExplosionRadius, BOOL IsAudible, BOOL IsVisible, float CamerShake) { invoke<Void>(0x27EE0D67, PedHandle, x, y, z, ExlosionType, ExplosionRadius, IsAudible, IsVisible, CamerShake); } // 0x27EE0D67
...
namespace WATER
{
	...
	static BOOL GET_WATER_HEIGHT(float x, float y, float z, float* height) { invoke<Void>(0xD864E17C, x, y, z, height); } // F6829842C06AE524 D864E17C
}
...
namespace NETWORK
{
	static void NETWORK_STOP_SYNCHRONISED_SCENE1(int netScene) { invoke<Void>(0x97B1CDF6, netScene); }// 0x97B1CDF6
	static int NETWORK_CREATE_SYNCHRONISED_SCENE_3(float x, float y, float z, float xrot, float yrot, float zrot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<int>(0xB06FE3FE, x, y, z, xrot, yrot, zrot, p6, p7, p8, p9, p10, p11); } // 0xB06FE3FE
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE_3(Ped player, int scene, char* anim, char* animid, float speed, float speedmul, int duration, int flag, float playbackr, Any p9) { invoke<Void>(0xB386713E, player, scene, anim, animid, speed, speedmul, duration, flag, playbackr, p9); } // 0xB386713E

	static void NETWORK_START_SYNCHRONISED_SCENE1(int netScene) { invoke<Void>(0xA9DFDC40, netScene); }// 0xA9DFDC40
	static void NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE1(Ped ped, int netScene, char* animDictionary, char* animationName, float speed, float speedMultiplier, int duration, int flag, float playbackRate) { invoke<Void>(0xB386713E, ped, netScene, animDictionary, animationName, speed, speedMultiplier, duration, flag, playbackRate); } //  0xB386713E
	static int NETWORK_CREATE_SYNCHRONISED_SCENE1(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<Any>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } //  0xB06FE3FE
	static Any NETWORK_IS_HANDLE_VALID2(int*, Any p0) { return invoke<Any>(0xF0996C6E, p0); } // 0xF0996C6E
	static void NETWORK_HANDLE_FROM_PLAYERTEST(Player player, int* networkHandle, int bufferSize) { invoke<Void>(0xD3498917, player, networkHandle, bufferSize); } // 0xD3498917
	static void _NETWORK_SET_FRIENDLY_FIRE_OPTION(BOOL toggle) { invoke<Void>(0x6BAF95FA, toggle); } // 0x6BAF95FA
	...
	static Any _0x56E75FE4() { return invoke<Any>(0x56E75FE4); } // 0x56E75FE4 - closed friends
	static Any _0xA95299B9() { return invoke<Any>(0xA95299B9); } // 0xA95299B9 - closed crew
	static Any _0x3D2C1916() { return invoke<Any>(0x3D2C1916); } // 0x3D2C1916 - solo
	static Any _0xDB67785D() { return invoke<Any>(0xDB67785D); } // 0xDB67785D - invite
	...
	static Any _0x42BD07802(Any* p0) { return invoke<Any>(0x42BD0780, p0); } // 0x42BD0780
	...
	static void NETWORK_HANDLE_FROM_USER_ID2(char* p0, int* p1, Any p2) { invoke<Void>(0x74C2C1B7, p0, p1, p2); } // 0x74C2C1B7
	static void NETWORK_HANDLE_FROM_MEMBER_ID(Any p0, Any p1, Any p2) { invoke<Void>(0x9BFC9FE2, p0, p1, p2); } // 0x9BFC9FE2
	static void NETWORK_HANDLE_FROM_PLAYER(Ped PedHandle, int FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
	static void NETWORK_HANDLE_FROM_PLAYER44(Ped PedHandle, int* FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
	static void NETWORK_HANDLE_FROM_PLAYER2(Ped PedHandle, int* FreeMemPointer, int p2) { invoke<Void>(0xD3498917, PedHandle, FreeMemPointer, p2); } // 0xD3498917
	...
	static char* NETWORK_GET_FRIEND_NAME2(Any p0) { return invoke<char*>(0x97420B6D, p0); } // 0x97420B6D
	//static const char* NETWORK_GET_FRIEND_NAME44 (Player player);
	static Any NETWORK_IS_FRIEND_ONLINE(Any p0) { return invoke<Any>(0xE0A42430, p0); } // 0xE0A42430
	static Any NETWORK_IS_FRIEND_ONLINE2(char* p0) { return invoke<Any>(0xE0A42430, p0); } // 0xE0A42430
	...
	static Any NETWORK_IS_FRIEND(int*) { return invoke<Any>(0x2DA4C282); } // 0x2DA4C282
	...
	static Any NETWORK_CREATE_SYNCHRONISED_SCENE(float x, float y, float z, float xRot, float yRot, float zRot, int p6, int p7, int p8, float p9, float p10, float p11) { return invoke<Any>(0xB06FE3FE, x, y, z, xRot, yRot, zRot, p6, p7, p8, p9, p10, p11); } // 0xB06FE3FE
	static int NETWORK_CREATE_SYNCHRONISED_SCENE0(float X, float Y, float Z, float XRot, float YRot, float ZRot, int fuckknows1, int fuckknows2, int fuckknows3, float f1, float f2, float f3) { return invoke<int>(0xB06FE3FE, X, Y, Z, XRot, YRot, ZRot, fuckknows1, fuckknows2, fuckknows3, f1, f2, f3); } // 0xB06FE3FE
...
namespace NETWORKCASH
{
	...
	static void NETWORK_SPENT_CASH_DROP2(Any p0) { invoke<Void>(0x87BD1D11, p0); } // 0x87BD1D11
